    ...
    const CALCULATOR_LIST = [
        {
            ...
            icon: LineChart,
            description:
                "Calculate how much your investment will grow over time through a Systematic Investment Plan (SIP). Understand the power of compound interest.",
        },
        {
            title: "Lump Sum Investment Calculator",
            icon: TrendingUp,
            description:
                "Estimate future returns and maturity value on a one-time (Lump Sum) investment. Set your financial goals.",
        },
        {
            title: "Retirement Corpus Planner",
            icon: UserRound,
            description:
                "Find out how much capital (corpus) you will need for retirement and how much you should start saving today.",
        },
        {
            title: "Loan EMI Calculator",
            icon: Home,
            description:
                "Accurately calculate the monthly installment (EMI) for your Home, Car, or Personal Loan. Simplify your budget.",
        },
    ];
                ...
                <div className="mx-auto max-w-6xl px-4 sm:px-6">
                    ...
                    <div className="text-center max-w-3xl mx-auto space-y-4 mb-10">
                        ...
                        <h2 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl dark:text-slate-50">
                            Free Financial Calculators: Optimize SIP, EMI, and
                            Retirement Planning.
                        </h2>

                        <p className="text-base leading-relaxed text-slate-700 dark:text-slate-300">
                            Accurately plan your financial goals using Capital
                            Mantra's investment and finance calculators.
                            Strengthen your capital with tools for SIP Returns,
                            EMI, and Retirement planning.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {CALCULATOR_LIST.map((calc, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="mb-3">
                                        <Icon className="w-10 h-10 text-fuchsia-600 dark:text-fuchsia-400" />
                                    </div>
