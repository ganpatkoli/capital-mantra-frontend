...
const Footer = ()=>{
    ...
    if ($[0] !== "6a544b94436117dc800848f90292cd395a8b4d83159fb7bede7ad2da85456140") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6a544b94436117dc800848f90292cd395a8b4d83159fb7bede7ad2da85456140";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Service$2f$api$2e$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/Service/api.config.js [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
...
function useAPI(path) {
    ...
    if ($[0] !== "987f02a70243a9a7be4f1876fc7565b4eb58232827905ccebc85a8cdbe01063b") {
        for(let $i = 0; $i < 21; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "987f02a70243a9a7be4f1876fc7565b4eb58232827905ccebc85a8cdbe01063b";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
    ...
    if ($[2] !== path) {
        t1 = ({
            "useAPI[fetchData]": async ()=>{
                ...
                ;
                try {
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Service$2f$api$2e$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(path);
                    setData(result);
                    setError(null);
                } catch (t2) {
                    const err = t2;
    ...
    if ($[4] !== path) {
        t2 = ({
            "useAPI[create]": async (body)=>{
                ;
                try {
                    const result_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Service$2f$api$2e$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])(path, body);
                    return result_0;
                } catch (t3) {
                    const err_0 = t3;
    ...
    if ($[6] !== path) {
        t3 = ({
            "useAPI[update]": async (body_0)=>{
                ;
                try {
                    const result_1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Service$2f$api$2e$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPut"])(path, body_0);
                    return result_1;
                } catch (t4) {
                    const err_1 = t4;
    ...
    if ($[8] !== path) {
        t4 = ({
            "useAPI[remove]": async ()=>{
                ;
                try {
                    const result_2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Service$2f$api$2e$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiDelete"])(path);
                    return result_2;
                } catch (t5) {
                    const err_2 = t5;
...
const IpoFilterBar = (t0)=>{
    ...
    if ($[0] !== "474084bbe2734cfe4358d9aa343bc96ba0c9a6205d5f2ced1373fa5244427bf3") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "474084bbe2734cfe4358d9aa343bc96ba0c9a6205d5f2ced1373fa5244427bf3";
    }
...
const BlogFilters = (t0)=>{
    ...
    if ($[0] !== "37550ffc468e60fa8727adc1474a5715e0e0056d081fbb2303b5d27d79ee1f48") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "37550ffc468e60fa8727adc1474a5715e0e0056d081fbb2303b5d27d79ee1f48";
    }
...
const CalculatorSection = ()=>{
    ...
    if ($[0] !== "2eddf04eefd513508ad65ff2542cc6679f3efb78fc02926967da84ecaa1fe053") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2eddf04eefd513508ad65ff2542cc6679f3efb78fc02926967da84ecaa1fe053";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [
...
const WhyIposMatterSection = ()=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(5);
    if ($[0] !== "9aa052318089528540273994a09267858cf1828fb8f4923e1eb3a91578bb29a6") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9aa052318089528540273994a09267858cf1828fb8f4923e1eb3a91578bb29a6";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
const AboutSection = ()=>{
    ...
    if ($[0] !== "f9a826a324b24ff578202064c86d22a0d72bbb650b241e4ce7b2fe5658755226") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f9a826a324b24ff578202064c86d22a0d72bbb650b241e4ce7b2fe5658755226";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_92baa5ef._.js.map