...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@/lib/apiService'");
...
function useAPI(path) {
    ...
    if ($[0] !== "ccea9a1edf83e67367ed8c3c467f5d86c2fac792c82baba8f38ff026ba98d393") {
        for(let $i = 0; $i < 21; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ccea9a1edf83e67367ed8c3c467f5d86c2fac792c82baba8f38ff026ba98d393";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
    ...
    if ($[4] !== path) {
        t2 = ({
            "useAPI[create]": async (body)=>{
                ;
                try {
                    const result_0 = await apiPost(path, body);
                    return result_0;
                } catch (t3) {
                    const err_0 = t3;
    ...
    if ($[6] !== path) {
        t3 = ({
            "useAPI[update]": async (body_0)=>{
                ;
                try {
                    const result_1 = await apiPut(path, body_0);
                    return result_1;
                } catch (t4) {
                    const err_1 = t4;
...
//# sourceMappingURL=src_286f8e08._.js.map